...
public class LearnDropDown {
	...
	public static void main(String[] args) {
		...
		driver.get("https://www.leafground.com/select.xhtml;jsessionid=node01oab7zrbhvhtm1sfj3hgxmsbap512140.node0");
	    //To maximize browser
		...
		//load the application url
				...
				driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Venture");
				...
				//Select value from Drop_Down -- drv to give element then press ctrl2L to make it as web ele =
				WebElement dd = driver.findElement(By.id("createLeadForm_dataSourceId"));
				
				 //Create a object for Select class  --the web ele strored above should be passed here in (arg)dd
